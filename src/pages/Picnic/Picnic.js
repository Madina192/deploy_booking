...
import football_1 from "../../imgs/picnic_1.jpg";
import football_2 from "../../imgs/picnic_2.jpg";
import picnic_3 from "../../imgs/picnic_3.jpg";
...
const Picnic = () => {
    ...
    return (
        <div className='football'>
            <h2 className="football-title">Picnic Area</h2>
            <div className="football-box">
                ...
                >
                    ...
                    <div className="football-min_box">
                        <img src={picnic_3} alt="" className="football-img"/>
                    </div>
                    <div className="football-min_box">
